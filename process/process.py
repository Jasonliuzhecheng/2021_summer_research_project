...
def get_time_vs_gl(dataset = "all", interval = "5m", cycle = "1d"):
	"""
...
def get_meal_vs_gl(dataset = "all", interval = "5m", max_duration = "4h"):
	"""
...
def get_snack_vs_gl(dataset = "all", interval = "5m", max_duration = "3h"):
	"""
...
def get_exercise_vs_gl(dataset = "all", interval = "5m", max_duration = "3h"):
	"""
...
def get_fast_insulin_time_vs_gl(dataset = "all", interval = "5m", max_duration = "4h"):
	"""
...
def get_strict_meal_vs_gl(dataset = "all", group = (1, 4), interval = "30m", cycle = "1d"):
	"""
...
def get_pre_meal_vs_gl(dataset = "all", group = (2, 3), interval = "30m", cycle = "1d"):
	"""
...
def get_trouble_sleep_vs_gl(dataset = "all", group = (1, ), interval = "30m", cycle = "1d"):
	"""
...
def get_weight_vs_gl(dataset = "all", group = (40, 60, 80), interval = "1h", cycle = "1d"):
	"""
...
def get_insulin_method_vs_gl(dataset = "all", interval = "30m", cycle = "1d"):
	"""
...
def get_diag_age(dataset = "all", group = (6, 16, 40, 60)):
	"""
...
def get_bld_pr_sys(dataset = "all", group = (120, 130, 140, 160)):
	"""
...
def get_bld_pr_dia(dataset = "all", group = (70, 80, 90, 100)):
	"""
...
def get_weight(dataset = "all", group = (40, 60, 80)):
	"""
...
def get_daily_insulin(dataset = "all", group = (20, 30, 40, 50, 60, 70)):
	"""
...
def get_weight_vs_daily_insulin(dataset = "all", group = (40, 60, 80)):
	"""
