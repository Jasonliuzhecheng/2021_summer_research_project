...
def setup_query():
	...
	print(get_weight_vs_daily_insulin(dataset = "all"))
	print(get_weight_vs_daily_insulin(dataset = ["Anderson2016", "Chase2005", "Tsalikian2005", "Weinstock2016"]))
	print(get_weight_vs_daily_insulin(dataset = "Anderson2016"))
	print(get_weight_vs_daily_insulin(dataset = "Buckingham2007"))
	print(get_weight_vs_daily_insulin(dataset = "Chase2005"))
	print(get_weight_vs_daily_insulin(dataset = "Tsalikian2005"))
	print(get_weight_vs_daily_insulin(dataset = "Weinstock2016"))

	print(get_weight_vs_gl(dataset = "all"))
	print(get_weight_vs_gl(dataset = ["Anderson2016", "Chase2005", "Weinstock2016"]))
	print(get_weight_vs_gl(dataset = "Anderson2016"))
	print(get_weight_vs_gl(dataset = "Buckingham2007"))
	print(get_weight_vs_gl(dataset = "Chase2005"))
	print(get_weight_vs_gl(dataset = "Tsalikian2005"))
	print(get_weight_vs_gl(dataset = "Weinstock2016"))

	print(get_daily_insulin(dataset = "all"))
	print(get_daily_insulin(dataset = ["Anderson2016", "Chase2005", "D1NAMO", "Tsalikian2005", "Weinstock2016"]))
	print(get_daily_insulin(dataset = "Anderson2016"))
	print(get_daily_insulin(dataset = "Buckingham2007"))
	print(get_daily_insulin(dataset = "Chase2005"))
	print(get_daily_insulin(dataset = "D1NAMO"))
	print(get_daily_insulin(dataset = "Tsalikian2005"))
	print(get_daily_insulin(dataset = "Weinstock2016"))

	print(get_weight(dataset = "all"))
	print(get_weight(dataset = ["Anderson2016", "Chase2005", "Tsalikian2005", "Weinstock2016"]))
	print(get_weight(dataset = "Anderson2016"))
	print(get_weight(dataset = "Buckingham2007"))
	print(get_weight(dataset = "Chase2005"))
	print(get_weight(dataset = "Tsalikian2005"))
	print(get_weight(dataset = "Weinstock2016"))

	print(get_fast_insulin_time_vs_gl(dataset = "all"))
	print(get_fast_insulin_time_vs_gl(dataset = "D1NAMO"))

	print(get_bld_pr_dia(dataset = "all"))
	print(get_bld_pr_dia(dataset = "Tamborlane2008"))

	print(get_bld_pr_sys(dataset = "all"))
	print(get_bld_pr_sys(dataset = "Tamborlane2008"))

	print(get_low_gl(dataset = "all"))
	print(get_low_gl(dataset = "Anderson2016"))
	print(get_low_gl(dataset = "Weinstock2016"))

	print(get_breakfast_ratio(dataset = "all"))
	print(get_breakfast_ratio(dataset = "Buckingham2007"))
	print(get_breakfast_ratio(dataset = "Chase2005"))

	print(get_lunch_ratio(dataset = "all"))
	print(get_lunch_ratio(dataset = "Buckingham2007"))
	print(get_lunch_ratio(dataset = "Chase2005"))

	print(get_dinner_ratio(dataset = "all"))
	print(get_dinner_ratio(dataset = "Buckingham2007"))
	print(get_dinner_ratio(dataset = "Chase2005"))
	...
	print(get_diag_age(dataset = "all"))
	print(get_diag_age(dataset = "Aleppo2017"))
	print(get_diag_age(dataset = "Anderson2016"))
	...
	print(get_time_vs_gl(dataset = ["Aleppo2017", "Anderson2016", "Chase2005", "Tamborlane2008", "Weinstock2016"]))
